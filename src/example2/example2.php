...
define('WEBSAYS_PUBLIC_FOLDER_PATH', WEBSAYS_ROOTPATH.'public/example2/');
...
list ($status, $chartsData, $error) = $api->GetChartsFacet(256, array('date', 'page_supertype', 'langDetected', 'phrases'), $sf);
